...
namespace Tagger
{
    public class XMLUtil
    {
        ...
        const string IMAGEFILETYPES = "ImageFileTypes";
        const string VIDEOFILETYPES = "VideoFileTypes";
        ...
        public class SaveSettings
        {
            ...
            public string VideoFileTypes { get; set; }
            ...
            try
            {
                ...
                new XElement(SETTINGSFIELD,
                    new XElement(PROFILEFIELD, new XAttribute(NAMEFIELD, profilename), new XAttribute(DEFAULTFIELD, "true"),
                        ...
                        new XElement(IMAGEFILETYPES, settings.ImageFileTypes),
                        new XElement(VIDEOFILETYPES, settings.VideoFileTypes),
        ...
        public bool SaveFile(SaveSettings settings, string profilename)
        {
            try
            {
                ...
                foreach (XElement itemElement in query)
                {
                    ...
                    itemElement.SetElementValue(IMAGEFILETYPES, settings.ImageFileTypes);
                    itemElement.SetElementValue(VIDEOFILETYPES, settings.VideoFileTypes);
        ...
        public SaveSettings LoadDefaultProfile()
        {
            SaveSettings setts = new SaveSettings
            {
                ...
                VideoFileTypes = ".mp4,.wmv,.avi,.mpg,.mkv,.flv,.webm,",
                //Png = true,
                //Jpg = true,
                //Jpeg = true,
                //Bmp = true,
            ...
            try
            {
                ...
                var query8 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(6).Value.ToString(); //ImageFileTypes
                var query9 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(7).Value.ToString(); //VideoFileTypes
                ...
                var query10 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(8).Value.ToString(); //mousedelay
                var query11 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(9).Value.ToString(); //visiblenav
                var query12 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(10).Value.ToString(); //BooruSource
                var query13 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(11).Value.ToString(); //BooruThreshold
                ...
                setts.ImageFileTypes = query8.First();
                setts.VideoFileTypes = query9.First();
                ...
                setts.Mousedisappeardelay = Convert.ToInt32(query10.First());
                setts.VisibleNav = (query11.First() == "true" ? true : false);
                setts.BooruSource = Convert.ToInt32(query12.First());
                setts.BooruThreshold = Convert.ToInt32(query13.First());
            }
            catch(Exception ex)
            {
                Error.WriteToLog(ex);
        ...
        public SaveSettings LoadProfile(string profilename)
        {
            ...
            try
            {
                ...
                var query7 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(6).Value.ToString(); //ImageFileTypes
                var query8 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(7).Value.ToString(); //VideoFiletypes
                ...
                var query9 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(8).Value.ToString(); //mousedelay
                var query10 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(9).Value.ToString(); //visiblenav
                var query11 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(10).Value.ToString(); //BooruSource
                var query12 = from item2 in profile.Elements() where item2.Attributes().ElementAt(1).Value.ToString() == "true" select item2.Elements().ElementAt(11).Value.ToString(); //BooruThreshold
                ...
                setts.ImageFileTypes = query7.First();
                setts.VideoFileTypes = query8.First();
                ...
                setts.Mousedisappeardelay = Convert.ToInt32(query9.First());
                setts.VisibleNav = (query10.First() == "true" ? true : false);
                setts.BooruSource = Convert.ToInt32(query11.First());
                setts.BooruThreshold = Convert.ToInt32(query12.First());
            }
            catch(Exception ex)
            {
                Error.WriteToLog(ex);
        ...
        public bool AddProfile(string profilename)
        {
            try
            {
                ...
                XElement toadd = new XElement(PROFILEFIELD, new XAttribute(NAMEFIELD, profilename), new XAttribute(DEFAULTFIELD, "false"),
                            ...
                            new XElement(VOLUMEFIELD, (30).ToString()),
                            new XElement(IMAGEFILETYPES, ".png,.jpg,.jpeg,.bmp,.gif,"),
                            new XElement(VIDEOFILETYPES, ".mp4,.wmv,.avi,.mpg,.mkv,.flv,.webm,"),
